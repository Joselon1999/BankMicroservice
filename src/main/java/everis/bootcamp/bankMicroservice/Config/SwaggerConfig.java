package everis.bootcamp.bankMicroservice.Config;
...
public class SwaggerConfig {
    ...
    public static final ApiInfo DEFAULT_API_INFO = new ApiInfo(
            "bankMicroservice","Microservice responsible for CRUD actions towards the BANK " +
            "WITH USAGE OF THE OTHERS MICROSERVICES",
            "1.0","urn:tos",
